                                        ...
                                        <tr>
                                            <td>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="${pageContext.request.contextPath}/LibriManagement?action=modifyUser"
                                                                      method="POST">

                                                                    <label>Id:</label><br>
                                                                    <input name="Id" type="text" maxlength="50"
                                                                           placeholder="Inserisci l'email" required><br>
                                                                    ...
                                                                    <input name="nome" type="text" maxlength="50"
                                                                           placeholder="Inserisci il nome" required><br>

                                                                    <label>Nazionalitá:</label><br>
                                                                    <input name="nazionalita" type="text" maxlength="50"
                                                                           placeholder="Inserisci la nazionalitá"
                                                                           required><br>

                                                                    <label>Etá:</label><br>
                                                                    <input name="eta" type="number" maxlength="50"
                                                                           placeholder="Inserisci l'etá" required><br>

                                                                    <label>Admin:</label><br>
                                                                    <input name="auth" type="text" maxlength="50"
                                                                           placeholder="Inserisci flag admin"
                                                                           required><br>
                                                ...
                                                <button class="btn btn-primary"
                                                        href="${pageContext.request.contextPath}/LibriManagement?action=deleteBook&isbn=<%=bean.getId_utente()%>">
                                                    <i class="fa fa-times"></i></button>
                                            </td>
                                            <td><%=bean.getId_utente()%>
                                            </td>
                                            <td><%=bean.getEmail()%>
                                            </td>
                                            <th scope="row">
